...
package ifneeded cluster::unix 0.2 [list source [file join $dir unix.tcl]]
package ifneeded cluster::wapi 0.1 [list source [file join $dir wapi.tcl]]
package ifneeded cluster::cli 0.1 [list source [file join $dir cli.tcl]]
